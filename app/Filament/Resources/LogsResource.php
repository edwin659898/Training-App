    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('start_time')->label('Start Date'),
                TextColumn::make('end_time')->label('End Date'),
            ...
            ->filters([
                SelectFilter::make('training_rating')
                    ->options([
                        '1' => 'Satisfactory',
                        '2' => 'Not Satisfactory',
                    ]),
                DateFilter::make('start_time')
                    ->label(__('Start At')),
                DateFilter::make('end_time')
                ->label(__('End At'))
            ])
            ->actions([
